...
const nextConfig = {
  ...
  async redirects() {
    ...
    // www.boisehandyman.co answers 200 with the same content as the apex host. The
    ...
    redirects.push({
      source: '/:path*',
      has: [{ type: 'host', value: 'www.boisehandyman.co' }],
      destination: 'https://boisehandyman.co/:path*',
      permanent: true,
    });
