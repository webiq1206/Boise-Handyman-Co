...
export function InlineEstimateCTA({
  title = "See what your fix might cost",
  description = "Get an instant planning range based on real Treasure Valley handyman job costs - takes about 60 seconds, no obligation.",
  className,
