      ...
      <div className="ed-panel ed-panel-reverse">
        <div className="ed-panel-media">
          <Image
            ...
            alt="Boise Handyman Co repair work in progress at a Treasure Valley home"
            fill
            loading="lazy"
          ...
          />
          <p className="ed-panel-caption">Prepared for the job · Representative imagery</p>
        </div>

        <div className="ed-panel-body">
          <Reveal>
            <p className="ed-eyebrow">How we work</p>
