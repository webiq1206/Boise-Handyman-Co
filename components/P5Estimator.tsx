...
import {deriveScopeAnswers,isExplicitProjectReplacement,reconcileScope,scopeQuestions,scopeAssumptions,validateScopeAnswer,type ScopeQuestion} from '@/lib/p5/adaptive';
