# Boise Handyman Co: P5 family visual audit, September 10, 2026

Site: https://boisehandyman.co. Recorded routes for this repository: 160.
...
The consolidated production route sweep and targeted reruns passed **1440 of 1440 route/viewport checks** (160 recorded routes at nine widths), with no recorded horizontal overflow, broken visible images, page exceptions, or console errors. All 10 route batches completed their internal-link checks without failures. [Full route workflow](https://github.com/webiq1206/Boise-Handyman-Co/actions/runs/34520563359) tested `cd2d80098182be9fa7a2c49fc0aa347e931a8914`.

The subsequent final component build passed **108 of 108 checks**, including responsive menus, sticky actions and form clearance, comparison input and sizing, and balanced cards. [Final component workflow](https://github.com/webiq1206/Boise-Handyman-Co/actions/runs/34522968053) tested `d9eb245e027642fa98c114d591bdc4dd34ea23bc`. Additional results: browser-results: 9 passing scenarios; launcher-results: 9 passing scenarios; mobile-navigation: 15 passing scenarios.
...
Supplemental route workflows: [run 34522530177](https://github.com/webiq1206/Boise-Handyman-Co/actions/runs/34522530177) at `6c5a9a22fd8f42af386d2f65a4d37ec15955f459`. Each row in the CSV identifies its actual tested source and run.
