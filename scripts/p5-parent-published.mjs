...
try {
 for(const width of widths) {
  ...
  for(const route of routes) {
   ...
   try {
    const response=await page.goto('https://p5homeco.com'+route,{waitUntil:'networkidle'});
  ...
  if(parent && width<1024) {
   try {
    ...
    await page.goto('https://p5homeco.com/',{waitUntil:'networkidle'});
  ...
  if(!parent) {
   try {
    await page.goto('https://p5homeco.com/p5-audit-fixture',{waitUntil:'networkidle'});
