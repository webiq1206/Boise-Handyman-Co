...
import { TASK_CATALOG, HOURLY_RATE_USD, TRIP_FEE_USD, MINIMUM_LABOR_HOURS, SUPPLY_RUN_HOURS, MAX_REASONABLE_HOURS } from "../shared/estimateEngine";
...
const SETS: Record<string, unknown> = { handyman: { TASK_CATALOG, HOURLY_RATE_USD, TRIP_FEE_USD, MINIMUM_LABOR_HOURS, SUPPLY_RUN_HOURS, MAX_REASONABLE_HOURS }, re10: { RECIPES, CREW_MINIMUM_PRICE, CREW_FOR_TRADE, REPAIR_GRADE_BY_DIVISION, WORTHWHILE_JOB_PRICE, QUOTE_VALID_DAYS, CREW_HOURLY_COST, MOBILIZATION_COST, REPAIR_GRADE_DEFAULT_FACTOR, LINE_ITEMS } };
