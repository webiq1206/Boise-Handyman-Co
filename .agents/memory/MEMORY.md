...
- [Neon nullable timestamps](neon-nullable-timestamps.md) — omit unset timestamp fields from Neon HTTP inserts; explicit null can serialize as an invalid empty timestamp.
