...
import {activeReplacementDigests,reconcileScope,scopeQuestionsForBrand as scopeQuestions,manualScopeAnswers,isExplicitProjectReplacement,replacementUploadIds} from "./adaptive";
